...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? PlaceholderHomeWidget() : LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => appStateNotifier.loggedIn
              ? PlaceholderHomeWidget()
              : LoginWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: PlaceholderHomeWidget.routeName,
          path: PlaceholderHomeWidget.routePath,
          builder: (context, params) => PlaceholderHomeWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: TvDetailsWidget.routeName,
          path: TvDetailsWidget.routePath,
